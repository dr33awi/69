// lib/features/prayer_times/screens/prayer_time_screen.dart - محسن مع نظام الأذونات الموحد
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'إذن الموقع مطلوب لحساب مواقيت الصلاة',
                    style: TextStyle(fontSize: 13.sp),
                  ),
                ),
              ],
            ...
            Expanded(
              child: RefreshIndicator(
                ...
                child: CustomScrollView(
                  ...
                  slivers: [
                    // عرض بطاقة تحذير الإذن إذا لم يكن ممنوحاً
                    if (!_hasLocationPermission && !_isLoading)
                      SliverToBoxAdapter(
                        child: _buildPermissionWarningCard(),
                      )
                    else if (_isLoading && _dailyTimes == null)
                      SliverFillRemaining(
                        child: Center(
                          child: Column(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'لحساب مواقيت الصلاة بدقة لمدينتك، يجب منح التطبيق إذن الوصول إلى موقعك الحالي',
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 13.sp,
              color: context.textSecondaryColor,
