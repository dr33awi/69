// lib/core/infrastructure/firebase/widgets/special_event/services/event_navigation_handler.dart
...
class EventNavigationHandler {
  ...
  static void _handleInternalNavigation(
    ...
    try {
      ...
      switch (path) {
        ...
        // ========== افتراضي ==========
        default:
          debugPrint('⚠️ [Navigation] Unknown path: $path');
          _showEventDetails(context, event);
      }
    } catch (e) {
  ...
  /// عرض مودال التفاصيل
  static void _showEventDetails(BuildContext context, SpecialEventModel event) {
    showModalBottomSheet(
      ...
      isDismissible: true,
      enableDrag: true,
      builder: (_) => EventDetailsModal(event: event),
    );
  }
